...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<c:url value="/resources/css/agency.css"></c:url>" rel="stylesheet">
...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#create">Tạo khảo sát</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Survey Website</div>
                <div class="intro-heading"><input type="text" style='color=#FFFF00'> </div>
                <a href="#services" class="page-scroll btn btn-xl">Search Survey</a>
            </div>
        </div>
    </header>
	...
	<script src="<c:url value="/resources/js/myjs.js" ></c:url>" charset="UTF-8"></script>
    ...
    <script src="<c:url value="/resources/js/agency.js"></c:url>"></script>
